...
public class RecyclerMasterSavings extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_recycler_master_savings);
    ...
    private void initRecyclerView() {
        ...
        RecyclerView recyclerView = findViewById(R.id.recycler_view_saving);
